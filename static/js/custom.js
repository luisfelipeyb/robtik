...
$(window).scroll(function(){ //browser scroll 
    $(".arrow").css("opacity", 1 - $(window).scrollTop() / 150); //set opacity css from 1 to -(negative) infinity of
    // element with class 'arrow'
  //250 is fade pixels
  });
});
...
$(document).ready(function(){ //when document is ready
  $("#projects-slider").owlCarousel({ //owlCarousel settings
